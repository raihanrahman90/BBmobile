...
class $AssetsImgGen {
  ...
  /// File path: assets/img/ic_launcher_background.png
  AssetGenImage get icLauncherBackground =>
      const AssetGenImage('assets/img/ic_launcher_background.png');

  /// File path: assets/img/ic_launcher_foreground.png
  AssetGenImage get icLauncherForeground =>
      const AssetGenImage('assets/img/ic_launcher_foreground.png');
  ...
  List<AssetGenImage> get values =>
      [appIcon, icLauncherBackground, icLauncherForeground, logo];
}
